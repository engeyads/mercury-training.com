...
<html lang="en">
    <head>
        ...
        ?> 
        <meta name="description" content="<?php echo isset($category) ? $category->description . $page : 'لا يوجد' ?>">
        <meta name="keywords" content="<?php echo  isset($category) ? $category->keyword : 'لا يوجد' ?>">
        <meta property="og:title" content="<?php echo $category->name ?>">
        <meta property="og:locale" content="en-SA">
        <meta property="og:type" content="website">
        <meta property="og:description" content="<?php echo isset($category) ? $category->description . $page : 'لا يوجد' ?>">
