...
<html lang="ar">
    <head>
        <meta name="description" content="<?php echo $centerName; ?> البرامج">
        <meta name="keywords" content="Mercury Courses, Learning, Training, Courses">
        <meta property="og:title" content="<?php echo $centerName; ?> البرامج">
        <meta property="og:locale" content="en-SA">
        <meta property="og:type" content="website">
        <meta property="og:description" content="<?php echo $centerName; ?> البرامج">
    ...
    <div class="container">
            <div class="cat-header">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <h1 class="tit-home d-flex justify-content-center d-md-inline-block justify-content-md-end" itemprop="name" content="<?php echo $centerName; ?> البرامج" title="<?php echo $centerName; ?> البرامج"> البرامج</h1>
                        <p class="par-home mt-3 mb-3 text-center text-md-end">
