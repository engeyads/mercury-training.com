<div class="upcoming-courses-contect mt-3">
    <div class="row">
                ...
                <div class="card cat-card">
                    <div class="card-body" style="min-height: 100px !important;">
                        ...
                        <p class="card-text up-info">
                            <span><i class="fa fa-calendar"></i> <?php echo generateEventFormatedDate($value->startDate,$value->endDate, 'ar'); ?></span>&nbsp;&nbsp;
        ...
        <div class="col-md-12 mt-3 text-center">
            <a title="<?php echo $centerName; ?>" href="<?php echo $systemUrl;?>upcoming.html" class="btn btn-primary p-3 p-lg-2 btn-md">المزيد من الدورات المؤكدة ...</a>
        </div>
    </div>
</div>