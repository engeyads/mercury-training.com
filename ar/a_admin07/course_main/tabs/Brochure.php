<form method="post" action="?page=course_main-replaceB" name="insertForm"
                enctype="multipart/form-data"><input name="id" type="hidden" id="id" value="<?php echo $id  ?>" /><div class="form-row">
