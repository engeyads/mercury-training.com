...
<div class="col-lg-12 mt-5">
    <div class="card">
        <div class="card-body">
            <h4 class="header-title">Upcomming Course Table</h4>
            ...
            if ($result_course_main && (mysql_num_rows($result_course_main) > 0)) {
                ...
                ?><a href="<?php echo $site_course_link_a.$id_course.$site_course_link_b; ?>" target="_blank" ><?php echo $row_course_main[name]; ?></a><?php
            };
