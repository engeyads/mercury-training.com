...
$user_nameA = addslashes($_POST['user_name']);
$pass_wordA = addslashes($_POST['pass_word']);
if($user_nameA == ""){
	$user_nameA = addslashes($_COOKIE['user_nameA']);
	$pass_wordA = addslashes($_COOKIE['pass_wordA']);
};
                ...
                <form name="form1" method="post" action="#">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="form-gp">
                            ...
                            <input type="password" id="exampleInputPassword1" name="pass_word">
                            <i class="ti-lock"></i>
                        </div>
