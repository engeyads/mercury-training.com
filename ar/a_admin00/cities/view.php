    ...
    <div class="row">
            ...
            <div class="card  w-100">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-5 tit-head-in">
                        <h4> Total Cities <div> <?php echo $numrows; ?></div>
                        </h4>
                    </div>
        ...
        <div class="col-md-4">
            ...
            <div class="but-head  h-100 d-flex align-items-end justify-content-end">
              ...
              ?><a href="index.php?page=cities-view" class="btn btn-primary font-weight-bold"> <i
                        class="fa fa-sort"></i> Sort by name</a><?php
            }else{
              ?><a href="index.php?page=cities-view&sort_by_price=1" class="btn btn-primary font-weight-bold"> <i
                        class="fa fa-sort"></i> Sort by Price</a><?php
            }?>
                <a href="index.php?page=cities-edit" class="btn btn-primary font-weight-bold ml-2"><i
                        class="fa fa-plus-square fa-fw "></i> Add City</a>
            </div>
            <!-- BUtton viwe end -->
        </div>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        <td colspan="19"></td>
                                                ...
                                                if($break == 0 and $break1 == 1){ ?><tr>
                                        <td colspan="19" class="alert-danger"></td>
                                    </tr><?php }
                                              }
                                              ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="?page=cities-edit&id=<?php echo $id ;?>"><?php echo $name ; if($monday == 1){ ?><span
                                                    class="badge badge-secondary ml-2"
                                                    style="background-color:darkgoldenrod">Monday</span><?php } ?></a>
                                        </td>

                                        <td><a href="?page=cities-edit&id=<?php echo $id ;?>"><i
                                                    class="fa fa-edit"></i></a></td>
                                        <td>
                                            <button class="button-del" type="button" data-toggle="modal"
                                                data-target="#exampleModal<?php echo $id ;?>"><i
                                                    class="ti-trash text-danger"></i></button>
                                            <div class="modal fade" id="exampleModal<?php echo $id ;?>" tabindex="-1"
                                                role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Delet City
                                                            </h5>
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <span class="b-remove"><a type="button"
                                                                    ...
                                                                    href="?page=cities-del&amp;id=<?php echo $id ;?>">Yes</a></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <td class="alert-success">
                                            ...
                                            <a href="?page=cities-edit&id=<?php echo $id ;?>"><?php  if($w1_p !=''){ echo $w1_p; }else{ ?><span
                                                    class="text-danger">X</span><?php }; ?></a>



                                        </td>
                                        <td class="alert-success"><a
                                                href="?page=cities-edit&id=<?php echo $id ;?>"><?php  if($w2_p !=''){ echo $w2_p; }else{ ?><span
                                                    class="text-danger">X</span><?php }; ?></a></td>

                                        <td class="alert-success"><a
                                                href="?page=cities-edit&id=<?php echo $id ;?>"><?php  if($w3_p !=''){ echo $w3_p; }else{ ?><span
                                                    class="text-danger">X</span><?php }; ?></a></td>
                                        <td class="alert-success"><a
                                                href="?page=cities-edit&id=<?php echo $id ;?>"><?php  if($w4_p !=''){ echo $w4_p; }else{ ?><span
                                                    class="text-danger">X</span><?php }; ?></a></td>
                                        <td class="alert-success"><a
                                                href="?page=cities-edit&id=<?php echo $id ;?>"><?php  if($x !=''){ echo $x; }else{ ?><span
                                                    class="text-danger">X</span><?php }; ?></a></td>
                                        <td class="alert-warning"><a
                                                href="?page=cities-edit&id=<?php echo $id ;?>"><?php  if($w1_p_b !=''){ echo $w1_p_b; }else{ ?><span
                                                    class="text-danger">X</span><?php }; ?></a></td>
                                        <td class="alert-warning"><a
                                                href="?page=cities-edit&id=<?php echo $id ;?>"><?php  if($w2_p_b !=''){ echo $w2_p_b; }else{ ?><span
                                                    class="text-danger">X</span><?php }; ?></a></td>

                                        <td class="alert-warning"><a
                                                href="?page=cities-edit&id=<?php echo $id ;?>"><?php  if($w3_p_b !=''){ echo $w3_p_b; }else{ ?><span
                                                    class="text-danger">X</span><?php }; ?></a></td>
                                        <td class="alert-warning"><a
                                                href="?page=cities-edit&id=<?php echo $id ;?>"><?php  if($w4_p_b !=''){ echo $w4_p_b; }else{ ?><span
                                                    class="text-danger">X</span><?php }; ?></a></td>
                                        <td class="alert-warning"><a
                                                href="?page=cities-edit&id=<?php echo $id ;?>"><?php  if($x_b !=''){ echo $x_b; }else{ ?><span
                                                    class="text-danger">X</span><?php }; ?></a></td>
                                        <td class="alert-info"><a
                                                href="?page=cities-edit&id=<?php echo $id ;?>"><?php  if($w1_p_c !=''){ echo $w1_p_c; }else{ ?><span
                                                    class="text-danger">X</span><?php }; ?></a></td>
                                        <td class="alert-info"><a
                                                href="?page=cities-edit&id=<?php echo $id ;?>"><?php  if($w2_p_c !=''){ echo $w2_p_c; }else{ ?><span
                                                    class="text-danger">X</span><?php }; ?></a></td>

                                        <td class="alert-info"><a
                                                href="?page=cities-edit&id=<?php echo $id ;?>"><?php  if($w3_p_c!=''){ echo $w3_p_c; }else{ ?><span
                                                    class="text-danger">X</span><?php }; ?></a></td>
                                        <td class="alert-info"><a
                                                href="?page=cities-edit&id=<?php echo $id ;?>"><?php  if($w4_p_c !=''){ echo $w4_p_c; }else{ ?><span
                                                    class="text-danger">X</span><?php }; ?></a></td>
                                        <td class="alert-info"><a
                                                href="?page=cities-edit&id=<?php echo $id ;?>"><?php  if($x_c !=''){ echo $x_c; }else{ ?><span
                                                    class="text-danger">X</span><?php }; ?></a></td>
                                    </tr>
                                    <?php
                                            }
                                        ...
                                        <td>
                                            ...
                                            if($start>0){
                                                ...
                                                <a href="?page=cities-view&start=<?php echo $start - $integer ; ?>
                                                            ...
                                                            <?php if ( isset($_GET['id_course_ar_c'] )){ echo "&id_course_ar_c=$id_course_ar_c"; }; ?>"
                                                    class="linlk">Previous</a>
                                                <?php
                                                };
                                            if($numrows>$end and $start>0){ echo " - ";};
                                                if($numrows>$end){
                                                ?><a
                                                    href="?page=cities-view&start=<?php echo $integer + $start; ?>
                                                        <?php if ( isset($_GET['id_course_ar_c_c'] )){ echo "&id_course_ar_c_c=$id_course_ar_c_c"; }; ?><?php if ( isset($_GET['id_course_ar_c'] )){ echo "&id_course_ar_c=$id_course_ar_c"; }; ?>"
                                                    class="linlk">Next</a>
                                                <?php
                                            };
                                            ?>
