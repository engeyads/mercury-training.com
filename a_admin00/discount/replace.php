...
add_edit('course_id',1,1,'');
add_edit('percentage',1,1,'');
add_edit('amount',1,1,'');
add_edit('count',1,1,'');
add_edit('used',1,1,'');
add_edit('expiry_date',1,1,'');

add_edit('city',1,1,'');
add_edit('admin_note',1,1,'');
add_edit('view_note',1,1,'');
...
?><meta http-equiv="refresh" content="0;URL=?page=discount-edit&id=<?php echo $id; ?>" /><?php
?>