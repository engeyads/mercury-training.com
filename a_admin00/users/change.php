<?php if($level_admin !=1){ exit; }?><h1 class="header-title ml-5">Change Password for: <?php echo $_GET[user_name]?></h1><br />
<br />
            ...
            <div class="main-content-inner">
                    ...
                    <div class="login-box">
                        <form method="post" action="index.php?page=users-change_r"><input name="user_name_ch" type="hidden" value="<?php echo $_GET[user_name];  ?>">
