...
mysql_query("DELETE FROM `cities` WHERE `id` = '" . $id . "' LIMIT 1", $conn);
mysql_query("DELETE FROM `course` WHERE `city` = '" . $id . "' ", $conn);
?><meta http-equiv="refresh" content="0;URL=?page=cities-view" /><?php
}else{
	?>
<form action="index.php?page=<?php echo $_GET[page]; ?>&amp;id=<?php echo $_GET[id]; ?>" method="post">
