...
<html lang="en">
    <head>
        ...
        ?>
        <meta name="description" content="<?php echo $course->description != '' ? $course->description : "$course->name Course"; ?>">
        <meta name="keywords" content="<?php echo !empty(($course->keyword!='' ? json_decode($course->keyword) : '')) ?  implode(', ',json_decode($course->keyword)) : "$course->name Course"; ?>">
        <meta property="og:title" content="<?php echo $course->title != '' ? $course->title : "$course->name Course"; ?>">
        <meta property="og:locale" content="en-SA">
        <meta property="og:type" content="website">
        <meta property="og:description" content="<?php echo $course->description != '' ? $course->description : "$course->name Course"; ?>">
        ...
        <div class="container">
            <div class="cat-header">
                <div class="row">
                    ...
                    <div class="col-md-2 py-4 py-lg-0 py-md-0">
                        <a href="#" onclick="window.print();" class="print-page no-print"> <i class="fa fa-print fa"></i>&nbsp;Print</a>
                        <a title="<?php echo $centerName; ?> Brochure" class="print-page no-print" href="<?php echo $systemUrl; ?>pdfb/index2.php?id=<?php echo $course->courseId; ?>"> <i class="fa fa-file-pdf fa"></i>&nbsp;PDF</a>
                    </div>
                    <div class="col-md-12">
