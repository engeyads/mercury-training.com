...
<html lang="en">
    ...
    <head>
        <meta name="description" content="<?php echo $centerName; ?> Cities">
        <meta name="keywords" content="Mercury cities">
        <meta property="og:title" content="<?php echo $centerName; ?> Cities">
        <meta property="og:locale" content="en-SA">
        <meta property="og:type" content="website">
        <meta property="og:description" content="<?php echo $centerName; ?> Cities">
            ...
            <div class="container">
                <div class="cat-header">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <h1 itemprop="name" content="" title="" class="categroy-title">Training Courses in Cities</h1>
                            <p class="cat-desc">
                            Elevate Your Learning Experience: Our Exceptional Training Course Venues
                            </p>
                        </div>
                    </div>
                </div>
