...
<html lang="en">
    <head>
        <meta name="description" content="Mercury Training Centre Course Inquiry Page">
    ...
    else
    {
        $msg = "
                <div class=\"info-client\" style='padding: 40px;'>
                    <h3><strong>Course Title: </strong>{$course->name}</h3>
                    <a href='{$courseLink}'>Click here to view the course on website</a>
                ...
                if($islocal == 0 and (mail($websiteEmail, $subject, $message, $headers))){
                    ...
                    <div class="container">
                        <div class="ok-inquiry ">
                            ...
                            <div>
                                <h1>THANK YOU</h1>
                                <h3>Inquiry has been Successfully Submitted</h3>
                            </div>
                        </div>
                    </div>
            </div>
            <?php
                    ...
                    <div class="container">
                        <div class="ok-inquiry not">
                            ...
                            <div>
                                <h1>Sorry!</h1>
                                <h3>Inquiry has not been Submitted Successfully</h3>
                            </div>
                        </div>
                    </div>
            <?php
