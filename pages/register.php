...
<html lang="en">
    <head>
        ...
        ?>
        <meta name="description" content="<?php echo $centerName; ?> Centre Register Page">
        ...
        <meta property="og:title" content="<?php echo $centerName; ?> Register">
        <meta property="og:locale" content="en-SA">
        <meta property="og:type" content="website">
        <meta property="og:description" content="<?php echo $centerName; ?> Center Register Page">
    ...
    <div class="inq-header">
        <div class="cat-header">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h1 itemprop="name" content="<?php echo $centerName . ' Register'; ?>" title="<?php echo $centerName . ' Register'; ?>" Policy class="categroy-title">Register: <?php echo $event->categoryName; ?> <br/> <?php echo $event->name; ?></h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="info pt-3 pb-2">
                        ...
                        <strong>LOCATIONS: </strong><?php echo $event->city; ?>&nbsp;
                        <strong>INDIVIDUAL FEE: </strong><?php echo $event->price; ?>&nbsp;<strong><?php echo $event->currency; ?></strong>

                        <p class="mt-3"><b>Please complete the following form required fields are indicated with an asterisk (<i class="fa fa-star text-danger"></i> ).</b></p>
                    </div>
                    <div>
                        <hr>
                        <div class="form">
                            ...
                            <form id="login" method="POST" name="registerationt" lang="en" action="<?php echo $systemUrl; ?><?php echo $registerReceive; ?>/<?php echo $event->id.'.html'; ?>">
                                <div class="cover-in-form">
                                    <div id="participants">
                                        <div class="participant" data-index="0">
                                            <h4 class="head-form">Delegate Information</h4>
                                            <div class="cover-group p-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="input-group input-group-sm mb-3">
                                                            <input name="participants[0][first_name]" type="text" class="form-control required-input" placeholder="First Name" required="">
                                                            <span class="input-group-text required-span text-danger">*</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div class="input-group input-group-sm mb-3">
                                                            <input name="participants[0][last_name]" type="text" class="form-control required-input" placeholder="Surname" required="">
                                                            <span class="input-group-text required-span text-danger">*</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div class="input-group input-group-sm mb-3">
                                                            <input name="participants[0][position]" type="text" id="position" class="form-control required-input" placeholder="Position" required="">
                                                            <span class="input-group-text required-span text-danger">*</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div class="input-group input-group-sm mb-3">
                                                            <input name="participants[0][mobile_number]" placeholder="Mobile Number (include country)" type="text" id="mobile_number" class="form-control required-input" required="">
                                                            <span class="input-group-text required-span text-danger">*</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div class="input-group input-group-sm mb-3">
                                                            <input name="participants[0][phone_number]" type="text" id="phone_number" class="form-control" placeholder="Phone Number(include country)">
                                                        </div>
                                                    </div>
                                                    
                                                    <!-- <div class="col-sm-4">
                                                        <div class="input-group input-group-sm mb-3">
                                                            <input name="participants[0][fax_number]" type="text" id="fax_number" placeholder=" Fax Number (include country)" class="form-control">
                                                        </div>
                                                    </div> -->
                                                    <div class="col-sm-4">
                                                        <div class="input-group input-group-sm mb-3">
                                                            <input name="participants[0][email]" type="email" id="email" placeholder="E-mail" required="" class="form-control required-input">
                                                            <span class="input-group-text required-span text-danger">*</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div class="input-group input-group-sm mb-3">
                                                            <input name="participants[0][cc]" type="email" id="cc" placeholder="Personal E-mail " class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <a class="btn btn-primary btn-sm ms-4 mb-4" id="add_delegate">
                                        <i class="far fa-plus-square me-1"></i>Add Delegate
                                    </a>
                                    
                                    <a class="btn btn-danger btn-sm ms-2 mb-4" id="remove_delegate" style="display: none">
                                        <i class="fas fa-trash-alt me-1"></i>Remove Delegate
                                    </a>
                                </div>
                                ...
                                <div class="cover-in-form">
                                    <h4 class="head-form">Company Information</h4>
                                    <div class="cover-group p-4">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="input-group input-group-sm mb-3">
                                                    <input name="company" type="text" id="company" class="form-control required-input" placeholder=" Company Name  " required>
                                                    <span class="input-group-text required-span text-danger">*</span>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="input-group input-group-sm mb-3">
                                                    <input name="city" type="text" id="city" placeholder="City" class="form-control required-input" required>
                                                    <span class="input-group-text required-span text-danger">*</span>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="input-group input-group-sm mb-3">
                                                    <input name="address" type="text" id="address" placeholder="Company Address " class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cover-in-form">
                                    <h4 class="head-form">Person Responsible for Training and Development</h4>
                                    <div class="cover-group p-4">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="input-group input-group-sm mb-3">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="input-group input-group-sm mb-3">
                                                    <input name="pr_first_name" type="text" id="pr_fire" class="form-control" placeholder="First Name ">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="input-group input-group-sm mb-3">
                                                    <input name="pr_last_name" type="text" id="pr_last_name" placeholder="Surname" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="input-group input-group-sm mb-3">
                                                    <input name="pr_position" type="text" id="pr_position" placeholder="Position" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="input-group input-group-sm mb-3">
                                                    <input name="pr_mobile_number" type="text" id="pr_mobile_number" placeholder="Mobile Number (include country)" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="input-group input-group-sm mb-3">
                                                    <input name="pr_phone_number" type="text" id="pr_phone_number" placeholder="Phone Number (include country)" class="form-control">
                                                </div>
                                            </div>
                                            
                                            <div class="col-sm-6">
                                                <div class="input-group input-group-sm mb-3">
                                                    <input name="pr_email" type="email" id="pr_email" placeholder="E-mail" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="input-group input-group-sm mb-3">
                                                ...
                                                <label class="form-check-label ml-2" for="exampleCheck1"><a class="text-secondary font-weight-bold" href="<?php echo $systemUrl; ?>terms-and-conditions.html" target="_blank"> <u>Accept
                                                            Terms and conditions</u> </a></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6" style="display:none;" id="submit_btn">
                                            <div class="form-group mb-3">
                                                <input title="Mercury Training Center Register" type="submit" id="btnSubmit" name="Submit" value="Register" class="inq-btn ps-5 pe-5">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    $(document).on('click', '#add_delegate', function(){
        ...
        html = html.replace('<h4 class="ms-4"></h4>', '<h4 class="ms-4">Delegate #'+ participant_number +' Information</h4>');
