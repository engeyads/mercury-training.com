...
if($_SERVER['HTTP_HOST'] == 'test.mercury-training.com' || $_SERVER['HTTP_HOST'] == 'www.test.mercury-training.com'){
	...
	$site_url= 'https://mercury-training.com';
}
...
// $sub_page3 = $parts[4+$config_corrector];
...
// $sql_select_ip = "SELECT * FROM `iptoc` WHERE `ip` = '$ip'";
// $result_select_ip = mysqli_query($conn, $sql_select_ip);

// if ($result_select_ip && (mysqli_num_rows($result_select_ip) > 0)) {
//     $row_select_ip = mysqli_fetch_assoc($result_select_ip);
//     $country = $row_select_ip['country'];
// } else {
//     $country = ip_info("Visitor", "Country Code");
//     $aa = "INSERT INTO `iptoc` (`ip`, `country`) VALUES ('{$ip}', '{$country}');";
...
$site_course_link_a = 'https://mercury-training.com/p/';
$site_course_link_b = '.html';
$site_course_link_b_admin_link = 'https://mercury-training.com/a_admin07/';
$site_course_link_pdf = 'https://mercury-training.com/pdfb/index.php?id=';
$site_course_link_pdf_course = '#';
$site_course_link_pdf_b = '';
$admin_title = 'Admin mercury English';
$adminweeks = 'week';
