...
if($_SERVER['HTTP_HOST'] == 'localhost'){
    define("DB_USER", 'root'); //national_en 
    define("DB_PASS", ''); // *%  
    define("DB_NAME", 'mercuryt_newen');//national_en 
    define("SITE_PATH", 'https://localhost/mercury-training.com'); // //http://localhost/mercury
    define("BASE_DIR", $_SERVER['DOCUMENT_ROOT'].'/mercury-training.com');//
    ...
    define("DB_NAME", 'mercuryt_newen');//national_ar
    define("SITE_PATH", 'https://mercury-training.test'); //
    define("BASE_DIR", $_SERVER['DOCUMENT_ROOT'].'/mercury-training.com');//
}elseif($_SERVER['HTTP_HOST'] == 'test.mercury-training.com'){
    define("DB_USER", 'mercurytraining_mct'); //national_ar // mercurytraining_ar
    define("DB_PASS", 'kkfRleRU2NoY'); //nWVGQ$y*%t0x // fsdfsdf$!@212@sSAA
    define("DB_NAME", 'mercuryt_newen');//national_ar
    define("SITE_PATH", 'https://test.mercury-training.com'); //
    define("BASE_DIR", $_SERVER['DOCUMENT_ROOT'].'/mercury-training.com/test.mercury-training.com');//
}else{
    define("DB_USER", 'mercurytraining_mct'); //national_en 
    define("DB_PASS", 'kkfRleRU2NoY'); // *%  
    define("DB_NAME", 'mercuryt_newen');//national_en
    define("SITE_PATH", 'https://mercury-training.com'); //
    define("BASE_DIR", $_SERVER['DOCUMENT_ROOT'].'');//
}


define("SITE_NAME", 'Mercury Training Center'); //
...
define("DefaultDescription", "Mercury Training Center");
